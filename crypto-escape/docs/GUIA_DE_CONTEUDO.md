...
## 7. Módulos de terminal (episódios 47, 48, 49, 50, 51, 52 e 53)
...
**Decisão de rumo:** os episódios 0-7 (programação) têm 111 salas contra 75 de terminal (47-53). O usuário apontou
...
1. Mais módulos de terminal/segurança (o pedido explícito é "vários", com ataque e defesa cronometrados):
   ...
   Faltam: Cloud (CLI fictícia estilo AWS), Firewall ao vivo (estender o "contain" do ep. 48 com um comando de bloqueio).
